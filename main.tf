...
resource "aws_instance" "AbhiBajLinux" {
  ...
  vpc_security_group_ids = ["sg-01da51cf8ccfc2ff6"] #This is in region us-east-1, If you are changing the SG, Please change the region on line 13 and add the new security group
  tags = var.tags
}
